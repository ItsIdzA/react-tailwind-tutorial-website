...
import { nightOwl } from "react-syntax-highlighter/dist/esm/styles/hljs/index.js";
...
export default function Hero() {
  ...
  return <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className='max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative'>
          ...
          <div className='relative order-2 w-full'>
            <div className='relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10'>
              <div className='bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-450px lg:h-[500px] border border-white/5'>
                {/* IDE HEADER */}
